...
Ollama :
 ...
 -- Interact with Llama3 in Python Using Ollama REST API# AI-ML Project
**AI & Data Science Using Python**

---

## 📘 Introduction
Introduction to **AI, ML, Data Science, Deep Learning, NLP, Generative AI, and Agentic AI** (Demo)

### Topics Covered
- Relationship between AI, ML, DL, NLP, Data Science, Gen AI, Agentic AI  
- Applications of Data Science  
- Why Python for Data Science  
- AI Tools: Claude, Perplexity, Copilot, ChatGPT, DeepSeek  
...
- Strings (Exercises)  
- Lists (Exercises, Case Studies)  
- Tuples (Exercises)  
- Dictionaries (Exercises, Case Studies)  
- Sets and Frozensets  
- Comprehensions  
  - List Comprehension  
  - Dictionary Comprehension  
...
### NumPy
- Introduction to NumPy and N-D Arrays  
- Data Types and Attributes  
- Mathematical Functions  
- Indexing, Slicing, Broadcasting  
- Core Python vs NumPy (Exercises & Case Studies)  

---

## 📊 Statistics
- Central Tendency: Mean, Median, Mode  
- Measures of Variation: IQR, Variance, Standard Deviation  
- Data Visualization:
  - Bar Chart  
  - Histogram  
  - Box Plot  
...
## 🎲 Probability
- Basics of Probability & Randomness  
...
- Indexing & Iteration  
- Merging & Joining  
- GroupBy, Pivot Tables, Binning  
- Pandas Visualization  
- Real-time Case Studies (Kaggle)  
...
### UI for Model Deployment
- HTML (Elements, Lists, Tables, Forms)  
...
- Deployment using Flask, FastAPI & Azure  
...
### Generative AI
- LLMs & Architectures  
- OpenAI, Gemini, LLaMA, Mistral, QWEN  
- Chatbots & Multimodal Models  
- Prompt Engineering  

### Ollama
- Ollama CLI & REST API  
- LLaVA & Llama3 Integration  
...
- Capstone Project on GenAI & Agentic AI  
