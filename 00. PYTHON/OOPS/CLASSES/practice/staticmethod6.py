...
while(1):
    try:
        ...
        nit.display(s,"Student") # calling Instance method by Name-Less object
        nit.display(e,"Employee")  # calling Instance method by Name-Less object
        nit.display(t,"Teacher") # calling Instance method by Name-Less object
        break
    except ValueError:
