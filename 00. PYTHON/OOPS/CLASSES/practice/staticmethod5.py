...
while(1):
    try:
        class nit:
            @classmethod
            def recieve(cls,obj,objinfo):
                cls.display(obj,objinfo)   # calling Static Method from Class Level Method w.r.t cls
            @staticmethod
        ...
        nit.display(s,"Student")  # calling Class Level method by Class name
        nit.display(e,"Employee")  # calling Class Level method by Class name
        nit.display(t,"Teacher")  # calling Class Level method by Class name
        break
    except ValueError:
