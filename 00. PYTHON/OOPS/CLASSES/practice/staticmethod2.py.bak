...
while(1):
    try:
        ...
        n = nit
        n.display(s,"Student")  # calling static method by using Class Name
        n.display(e,"Employee")  # calling static method by using Class Name
        n.display(t,"Teacher")  # calling static method by using Class Name
        break
    except ValueError:
